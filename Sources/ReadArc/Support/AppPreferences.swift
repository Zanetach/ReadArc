...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "updates.later": "Later",
        "updates.ok": "OK",
        "permission.fileAccess.title": "Set Up ReadArc Library",
        "permission.fileAccess.message": "Choose a library folder once. ReadArc will import PDFs there, then Chat, search, thumbnails, and indexing can reuse that folder without asking for every PDF.",
        "permission.fileAccess.continue": "Choose Folder",
        "permission.fileAccess.cancel": "Open Once",
        "openPDF.error.title": "Unable to Open PDF",
        "openPDF.error.notPDF": "The selected file is not a PDF.",
        "openPDF.error.failed": "ReadArc could not read this PDF. Try opening it again or choose another file.",
        "openPDF.error.missing": "This PDF was moved or deleted. Choose the file again to reopen it.",
        "openPDF.error.missing.removed": "This PDF was moved or deleted, so ReadArc removed it from your Library list. Choose the file again to reopen it.",
        "openPDF.error.dropNotPDF": "Drop a PDF file to open it.",
        ...
        "toolbar.selectText": "Select Text",
        "toolbar.panPage": "Pan Page",
        ...
        "library.folder.unset": "No Library Folder",
        "library.folder.current": "Library: %@",
        "library.folder.panel.message": "Choose a folder where ReadArc can import PDFs and reuse access for reading, search, and Chat.",
        "library.folder.panel.choose": "Use Folder",
        ...
        "panel.research.subtitle": "Search matches and outline.",
        ...
        "inspector.summary.excerpt": "Page %d excerpt: %@",
        "inspector.summary.loading": "Opening and extracting text from this PDF...",
        "inspector.summary.metadata": "%@ · %d pages · %@ · %d outline items. Text extraction is not available yet, so this card is showing document metadata.",
        ...
        "chat.prompt.mindMap": "Create a compact mind map for the current PDF page. Use a plain tree format: one root line, top-level branches with ├─ or └─, and child nodes with │ indentation. Do not wrap the answer in prose.",
    ...
    private static let zhHans: [String: String] = [
        ...
        "updates.later": "稍后",
        "updates.ok": "好",
        "permission.fileAccess.title": "设置 ReadArc 资料库",
        "permission.fileAccess.message": "选择一个资料库文件夹一次。之后 ReadArc 会把 PDF 导入这里，Chat、搜索、缩略图和索引都复用这个文件夹权限，不需要每个 PDF 都授权。",
        "permission.fileAccess.continue": "选择文件夹",
        "permission.fileAccess.cancel": "仅本次打开",
        "openPDF.error.title": "无法打开 PDF",
        "openPDF.error.notPDF": "所选文件不是 PDF。",
        "openPDF.error.failed": "ReadArc 无法读取这个 PDF。请重试，或选择另一个文件。",
        "openPDF.error.missing": "这个 PDF 已被移动或删除。请重新选择文件后再打开。",
        "openPDF.error.missing.removed": "这个 PDF 已被移动或删除，ReadArc 已从资料库列表中移除。请重新选择文件后再打开。",
        "openPDF.error.dropNotPDF": "请拖入一个 PDF 文件。",
        ...
        "toolbar.selectText": "选择文本",
        "toolbar.panPage": "拖动页面",
        ...
        "library.folder.unset": "未设置资料库",
        "library.folder.current": "资料库：%@",
        "library.folder.panel.message": "选择一个文件夹，ReadArc 会把 PDF 导入这里，并复用权限用于阅读、搜索和 Chat。",
        "library.folder.panel.choose": "使用文件夹",
        ...
        "panel.research.subtitle": "搜索命中和大纲。",
        ...
        "inspector.summary.excerpt": "第 %d 页摘录：%@",
        "inspector.summary.loading": "正在打开 PDF 并提取文本...",
        "inspector.summary.metadata": "%@ · %d 页 · %@ · %d 条大纲。暂时没有可提取文本，所以这里显示文档元信息。",
        ...
        "chat.prompt.mindMap": "请为当前 PDF 页面生成一份紧凑思维导图。使用纯文本树形格式：第一行是根节点，一级分支使用 ├─ 或 └─，子节点使用 │ 缩进。不要额外解释。",
